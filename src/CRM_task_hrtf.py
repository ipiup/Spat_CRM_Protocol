...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisTrials_2loc in trials_2loc:
        ...
        J8.reset()
        ######
        # old psychopy code for sound 
        #Target_1.setSound(Target_2loc, hamming=True)
        #Target_1.setVolume(1.0, log=False)
        ##################HRTF########################
        #fs = Target_1.sampleRate
        #src_array = Target_1.sndArr
        #src_array = np.asarray(src_array)
        
        #src_array = src_array.squeeze() # stereo en mono pour sf.sound
        ...
        Marsker_1.setVolume(0.0, log=False)
        Marsker_1.seek(0)
