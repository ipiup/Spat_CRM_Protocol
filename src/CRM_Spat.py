...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisTrial in trials:
        ...
        trial = data.Routine(
            name='trial',
            components=[text_instruction, R1, R2, R3, R4, R5, R6, R7, R8, B1, B2, B3, B4, B5, B6, B7, B8, V1, V2, V3, V4, V5, V6, V7, V8, J1, J2, J3, J4, J5, J6, J7, J8, sound_1],
        )
        ...
        trials.addData('R1.numClicks', R1.numClicks)
        if R1.numClicks:
           trials.addData('R1.timesOn', R1.timesOn)
           trials.addData('R1.timesOff', R1.timesOff)
        else:
           trials.addData('R1.timesOn', "")
           trials.addData('R1.timesOff', "")
        trials.addData('R2.numClicks', R2.numClicks)
        if R2.numClicks:
           trials.addData('R2.timesOn', R2.timesOn)
           trials.addData('R2.timesOff', R2.timesOff)
        else:
           trials.addData('R2.timesOn', "")
           trials.addData('R2.timesOff', "")
        trials.addData('R3.numClicks', R3.numClicks)
        if R3.numClicks:
           trials.addData('R3.timesOn', R3.timesOn)
           trials.addData('R3.timesOff', R3.timesOff)
        else:
           trials.addData('R3.timesOn', "")
           trials.addData('R3.timesOff', "")
        trials.addData('R4.numClicks', R4.numClicks)
        if R4.numClicks:
           trials.addData('R4.timesOn', R4.timesOn)
           trials.addData('R4.timesOff', R4.timesOff)
        else:
           trials.addData('R4.timesOn', "")
           trials.addData('R4.timesOff', "")
        trials.addData('R5.numClicks', R5.numClicks)
        if R5.numClicks:
           trials.addData('R5.timesOn', R5.timesOn)
           trials.addData('R5.timesOff', R5.timesOff)
        else:
           trials.addData('R5.timesOn', "")
           trials.addData('R5.timesOff', "")
        trials.addData('R6.numClicks', R6.numClicks)
        if R6.numClicks:
           trials.addData('R6.timesOn', R6.timesOn)
           trials.addData('R6.timesOff', R6.timesOff)
        else:
           trials.addData('R6.timesOn', "")
           trials.addData('R6.timesOff', "")
        trials.addData('R7.numClicks', R7.numClicks)
        if R7.numClicks:
           trials.addData('R7.timesOn', R7.timesOn)
           trials.addData('R7.timesOff', R7.timesOff)
        else:
           trials.addData('R7.timesOn', "")
           trials.addData('R7.timesOff', "")
        trials.addData('R8.numClicks', R8.numClicks)
        if R8.numClicks:
           trials.addData('R8.timesOn', R8.timesOn)
           trials.addData('R8.timesOff', R8.timesOff)
        else:
           trials.addData('R8.timesOn', "")
           trials.addData('R8.timesOff', "")
        trials.addData('B1.numClicks', B1.numClicks)
        if B1.numClicks:
           trials.addData('B1.timesOn', B1.timesOn)
           trials.addData('B1.timesOff', B1.timesOff)
        else:
           trials.addData('B1.timesOn', "")
           trials.addData('B1.timesOff', "")
        trials.addData('B2.numClicks', B2.numClicks)
        if B2.numClicks:
           trials.addData('B2.timesOn', B2.timesOn)
           trials.addData('B2.timesOff', B2.timesOff)
        else:
           trials.addData('B2.timesOn', "")
           trials.addData('B2.timesOff', "")
        trials.addData('B3.numClicks', B3.numClicks)
        if B3.numClicks:
           trials.addData('B3.timesOn', B3.timesOn)
           trials.addData('B3.timesOff', B3.timesOff)
        else:
           trials.addData('B3.timesOn', "")
           trials.addData('B3.timesOff', "")
        trials.addData('B4.numClicks', B4.numClicks)
        if B4.numClicks:
           trials.addData('B4.timesOn', B4.timesOn)
           trials.addData('B4.timesOff', B4.timesOff)
        else:
           trials.addData('B4.timesOn', "")
           trials.addData('B4.timesOff', "")
        trials.addData('B5.numClicks', B5.numClicks)
        if B5.numClicks:
           trials.addData('B5.timesOn', B5.timesOn)
           trials.addData('B5.timesOff', B5.timesOff)
        else:
           trials.addData('B5.timesOn', "")
           trials.addData('B5.timesOff', "")
        trials.addData('B6.numClicks', B6.numClicks)
        if B6.numClicks:
           trials.addData('B6.timesOn', B6.timesOn)
           trials.addData('B6.timesOff', B6.timesOff)
        else:
           trials.addData('B6.timesOn', "")
           trials.addData('B6.timesOff', "")
        trials.addData('B7.numClicks', B7.numClicks)
        if B7.numClicks:
           trials.addData('B7.timesOn', B7.timesOn)
           trials.addData('B7.timesOff', B7.timesOff)
        else:
           trials.addData('B7.timesOn', "")
           trials.addData('B7.timesOff', "")
        trials.addData('B8.numClicks', B8.numClicks)
        if B8.numClicks:
           trials.addData('B8.timesOn', B8.timesOn)
           trials.addData('B8.timesOff', B8.timesOff)
        else:
           trials.addData('B8.timesOn', "")
           trials.addData('B8.timesOff', "")
        trials.addData('V1.numClicks', V1.numClicks)
        if V1.numClicks:
           trials.addData('V1.timesOn', V1.timesOn)
           trials.addData('V1.timesOff', V1.timesOff)
        else:
           trials.addData('V1.timesOn', "")
           trials.addData('V1.timesOff', "")
        trials.addData('V2.numClicks', V2.numClicks)
        if V2.numClicks:
           trials.addData('V2.timesOn', V2.timesOn)
           trials.addData('V2.timesOff', V2.timesOff)
        else:
           trials.addData('V2.timesOn', "")
           trials.addData('V2.timesOff', "")
        trials.addData('V3.numClicks', V3.numClicks)
        if V3.numClicks:
           trials.addData('V3.timesOn', V3.timesOn)
           trials.addData('V3.timesOff', V3.timesOff)
        else:
           trials.addData('V3.timesOn', "")
           trials.addData('V3.timesOff', "")
        trials.addData('V4.numClicks', V4.numClicks)
        if V4.numClicks:
           trials.addData('V4.timesOn', V4.timesOn)
           trials.addData('V4.timesOff', V4.timesOff)
        else:
           trials.addData('V4.timesOn', "")
           trials.addData('V4.timesOff', "")
        trials.addData('V5.numClicks', V5.numClicks)
        if V5.numClicks:
           trials.addData('V5.timesOn', V5.timesOn)
           trials.addData('V5.timesOff', V5.timesOff)
        else:
           trials.addData('V5.timesOn', "")
           trials.addData('V5.timesOff', "")
        trials.addData('V6.numClicks', V6.numClicks)
        if V6.numClicks:
           trials.addData('V6.timesOn', V6.timesOn)
           trials.addData('V6.timesOff', V6.timesOff)
        else:
           trials.addData('V6.timesOn', "")
           trials.addData('V6.timesOff', "")
        trials.addData('V7.numClicks', V7.numClicks)
        if V7.numClicks:
           trials.addData('V7.timesOn', V7.timesOn)
           trials.addData('V7.timesOff', V7.timesOff)
        else:
           trials.addData('V7.timesOn', "")
           trials.addData('V7.timesOff', "")
        trials.addData('V8.numClicks', V8.numClicks)
        if V8.numClicks:
           trials.addData('V8.timesOn', V8.timesOn)
           trials.addData('V8.timesOff', V8.timesOff)
        else:
           trials.addData('V8.timesOn', "")
           trials.addData('V8.timesOff', "")
        trials.addData('J1.numClicks', J1.numClicks)
        if J1.numClicks:
           trials.addData('J1.timesOn', J1.timesOn)
           trials.addData('J1.timesOff', J1.timesOff)
        else:
           trials.addData('J1.timesOn', "")
           trials.addData('J1.timesOff', "")
        trials.addData('J2.numClicks', J2.numClicks)
        if J2.numClicks:
           trials.addData('J2.timesOn', J2.timesOn)
           trials.addData('J2.timesOff', J2.timesOff)
        else:
           trials.addData('J2.timesOn', "")
           trials.addData('J2.timesOff', "")
        trials.addData('J3.numClicks', J3.numClicks)
        if J3.numClicks:
           trials.addData('J3.timesOn', J3.timesOn)
           trials.addData('J3.timesOff', J3.timesOff)
        else:
           trials.addData('J3.timesOn', "")
           trials.addData('J3.timesOff', "")
        trials.addData('J4.numClicks', J4.numClicks)
        if J4.numClicks:
           trials.addData('J4.timesOn', J4.timesOn)
           trials.addData('J4.timesOff', J4.timesOff)
        else:
           trials.addData('J4.timesOn', "")
           trials.addData('J4.timesOff', "")
        trials.addData('J5.numClicks', J5.numClicks)
        if J5.numClicks:
           trials.addData('J5.timesOn', J5.timesOn)
           trials.addData('J5.timesOff', J5.timesOff)
        else:
           trials.addData('J5.timesOn', "")
           trials.addData('J5.timesOff', "")
        trials.addData('J6.numClicks', J6.numClicks)
        if J6.numClicks:
           trials.addData('J6.timesOn', J6.timesOn)
           trials.addData('J6.timesOff', J6.timesOff)
        else:
           trials.addData('J6.timesOn', "")
           trials.addData('J6.timesOff', "")
        trials.addData('J7.numClicks', J7.numClicks)
        if J7.numClicks:
           trials.addData('J7.timesOn', J7.timesOn)
           trials.addData('J7.timesOff', J7.timesOff)
        else:
           trials.addData('J7.timesOn', "")
           trials.addData('J7.timesOff', "")
        trials.addData('J8.numClicks', J8.numClicks)
        if J8.numClicks:
           trials.addData('J8.timesOn', J8.timesOn)
           trials.addData('J8.timesOff', J8.timesOff)
        else:
           trials.addData('J8.timesOn', "")
           trials.addData('J8.timesOff', "")
        ...
        trials.addData('Pasdeffort.numClicks', Pasdeffort.numClicks)
        if Pasdeffort.numClicks:
           trials.addData('Pasdeffort.timesOn', Pasdeffort.timesOn)
           trials.addData('Pasdeffort.timesOff', Pasdeffort.timesOff)
        else:
           trials.addData('Pasdeffort.timesOn', "")
           trials.addData('Pasdeffort.timesOff', "")
        trials.addData('__1.numClicks', __1.numClicks)
        if __1.numClicks:
           trials.addData('__1.timesOn', __1.timesOn)
           trials.addData('__1.timesOff', __1.timesOff)
        else:
           trials.addData('__1.timesOn', "")
           trials.addData('__1.timesOff', "")
        trials.addData('Trespeudeffort.numClicks', Trespeudeffort.numClicks)
        if Trespeudeffort.numClicks:
           trials.addData('Trespeudeffort.timesOn', Trespeudeffort.timesOn)
           trials.addData('Trespeudeffort.timesOff', Trespeudeffort.timesOff)
        else:
           trials.addData('Trespeudeffort.timesOn', "")
           trials.addData('Trespeudeffort.timesOff', "")
        trials.addData('__2.numClicks', __2.numClicks)
        if __2.numClicks:
           trials.addData('__2.timesOn', __2.timesOn)
           trials.addData('__2.timesOff', __2.timesOff)
        else:
           trials.addData('__2.timesOn', "")
           trials.addData('__2.timesOff', "")
        trials.addData('Peudeffort.numClicks', Peudeffort.numClicks)
        if Peudeffort.numClicks:
           trials.addData('Peudeffort.timesOn', Peudeffort.timesOn)
           trials.addData('Peudeffort.timesOff', Peudeffort.timesOff)
        else:
           trials.addData('Peudeffort.timesOn', "")
           trials.addData('Peudeffort.timesOff', "")
        trials.addData('__3.numClicks', __3.numClicks)
        if __3.numClicks:
           trials.addData('__3.timesOn', __3.timesOn)
           trials.addData('__3.timesOff', __3.timesOff)
        else:
           trials.addData('__3.timesOn', "")
           trials.addData('__3.timesOff', "")
        trials.addData('Effortmodere.numClicks', Effortmodere.numClicks)
        if Effortmodere.numClicks:
           trials.addData('Effortmodere.timesOn', Effortmodere.timesOn)
           trials.addData('Effortmodere.timesOff', Effortmodere.timesOff)
        else:
           trials.addData('Effortmodere.timesOn', "")
           trials.addData('Effortmodere.timesOff', "")
        trials.addData('__4.numClicks', __4.numClicks)
        if __4.numClicks:
           trials.addData('__4.timesOn', __4.timesOn)
           trials.addData('__4.timesOff', __4.timesOff)
        else:
           trials.addData('__4.timesOn', "")
           trials.addData('__4.timesOff', "")
        trials.addData('Effortconsiderable.numClicks', Effortconsiderable.numClicks)
        if Effortconsiderable.numClicks:
           trials.addData('Effortconsiderable.timesOn', Effortconsiderable.timesOn)
           trials.addData('Effortconsiderable.timesOff', Effortconsiderable.timesOff)
        else:
           trials.addData('Effortconsiderable.timesOn', "")
           trials.addData('Effortconsiderable.timesOff', "")
        trials.addData('__5.numClicks', __5.numClicks)
        if __5.numClicks:
           trials.addData('__5.timesOn', __5.timesOn)
           trials.addData('__5.timesOff', __5.timesOff)
        else:
           trials.addData('__5.timesOn', "")
           trials.addData('__5.timesOff', "")
        trials.addData('Beaucoupdeffort.numClicks', Beaucoupdeffort.numClicks)
        if Beaucoupdeffort.numClicks:
           trials.addData('Beaucoupdeffort.timesOn', Beaucoupdeffort.timesOn)
           trials.addData('Beaucoupdeffort.timesOff', Beaucoupdeffort.timesOff)
        else:
           trials.addData('Beaucoupdeffort.timesOn', "")
           trials.addData('Beaucoupdeffort.timesOff', "")
        trials.addData('Quedubruit.numClicks', Quedubruit.numClicks)
        if Quedubruit.numClicks:
           trials.addData('Quedubruit.timesOn', Quedubruit.timesOn)
           trials.addData('Quedubruit.timesOff', Quedubruit.timesOff)
        else:
           trials.addData('Quedubruit.timesOn', "")
           trials.addData('Quedubruit.timesOff', "")
    ...
    # completed 32 repeats of 'trials'
